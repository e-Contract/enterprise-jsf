...
@FacesComponent(TableUpdateComponent.COMPONENT_TYPE)
@ResourceDependencies({
    @ResourceDependency(library = "ejsf", name = "ejsf-table.css"),
    @ResourceDependency(library = "javax.faces", name = "jsf.js"),
    @ResourceDependency(library = "ejsf", name = "ejsf-widget.js"),
    @ResourceDependency(library = "ejsf", name = "ejsf-widget-update.js"),
    @ResourceDependency(library = "ejsf", name = "ejsf-table-update.js")
})
public class TableUpdateComponent extends UIOutput {

    private static final Logger LOGGER = LoggerFactory.getLogger(TableUpdateComponent.class);

    public static final String COMPONENT_TYPE = "ejsf.tableUpdateComponent";

    public static final String COMPONENT_FAMILY = "ejsf";

    public TableUpdateComponent() {
    ...
    public void encodeBegin(FacesContext context) throws IOException {
        ...
        html.element("table", () -> {
            ...
            html.attr("data-ejsf-widget-type", "TableUpdateWidget");
    ...
    private void update(FacesContext facesContext) {
        ...
        updateData += "]";
        UpdatePartialResponseWriter.updateWidget(facesContext, this, updateData);
    }

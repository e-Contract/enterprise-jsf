...
public class TableComponent extends UIOutput {
    ...
    public static final String COMPONENT_TYPE = "ejsf.tableComponent";
    ...
    public void encodeBegin(FacesContext context) throws IOException {
        ...
        html.element("table", () -> {
            ...
            html.attr("data-ejsf-widget-type", "TableWidget");

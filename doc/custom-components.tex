...
When creating CSS styles as part of a JSF component library, it is important to properly prefix your CSS classes to prevent clashes with other styles within your web applications.
...
JSF also allows you to define components that only perform on the client-side.

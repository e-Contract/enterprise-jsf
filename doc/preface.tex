...
Although many excellent references cover JSF (now Jakarta Faces), none focus exclusively on building custom UI components.
...
Rather than diving immediately into technical details, let us first consider the broader business context.
...
Enterprises prioritize low‑risk, cost‑effective long‑term maintenance of their substantial investments.
This goal conflicts often with the goal of its freelancers: filling up CVs with cut‑edge technologies, and trying to monthly invoice for as long as possible.
...
Hence a lot of companies find themselves in the situation where they are stuck with unmaintainable maintenance costs on their large corner stone projects, and nobody has the decency to step forward and admit the stupidities made that is incurring unsustainable maintenance costs.

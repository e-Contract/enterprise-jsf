...
public class WebAuthnRegisterTagHandler extends TagHandler {

    private final TagAttribute forAttribute;

    public WebAuthnRegisterTagHandler(TagConfig tagConfig) {
        super(tagConfig);
    ...
    public void apply(FaceletContext context, UIComponent parent) throws IOException {
        ...
        if (parent instanceof ActionSource2) {
            ...
            WebAuthnRegisterActionListener actionListener = new WebAuthnRegisterActionListener(forValue);

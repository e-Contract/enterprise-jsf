...
@FacesComponent(ClockSyncListenerComponent.COMPONENT_TYPE)
public class ClockSyncListenerComponent extends UIComponentBase {

    public static final String COMPONENT_TYPE = "ejsf.clockSyncListener";
